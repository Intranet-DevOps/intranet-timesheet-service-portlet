 ...
 * @generated
 */
public abstract class TimesheetDetailsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TimesheetDetailsActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TimesheetDetailsLocalServiceUtil.getService());
		setClass(TimesheetDetails.class);

		setClassLoader(sg.com.para.intranet.timesheet.services.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("timesheetDetailsId");
	}
}
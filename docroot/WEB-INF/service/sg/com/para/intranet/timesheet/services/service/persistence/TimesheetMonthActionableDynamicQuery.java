 ...
 * @generated
 */
public abstract class TimesheetMonthActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TimesheetMonthActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TimesheetMonthLocalServiceUtil.getService());
		setClass(TimesheetMonth.class);

		setClassLoader(sg.com.para.intranet.timesheet.services.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("timesheetMonthId");
	}
}
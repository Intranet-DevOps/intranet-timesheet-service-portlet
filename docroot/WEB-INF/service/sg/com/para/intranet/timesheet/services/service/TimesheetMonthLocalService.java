...
/**
 * Provides the local service interface for TimesheetMonth. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Fernando Karnagi
 * @see TimesheetMonthLocalServiceUtil
...
public interface TimesheetMonthLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TimesheetMonthLocalServiceUtil} to access the timesheet month local service. Add custom service methods to {@link sg.com.para.intranet.timesheet.services.service.impl.TimesheetMonthLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
